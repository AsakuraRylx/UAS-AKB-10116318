package com.uas.syahrilasidiq.fragment;
...
import com.uas.syahrilasidiq.presenter.ContactPresenter;
import com.uas.syahrilasidiq.view.ContactView;
...
public class ContactFragment extends Fragment implements ContactView, View.OnClickListener {
    ...
    public void actionCall() {
        Intent i = new Intent(Intent.ACTION_DIAL, Uri.fromParts("tel","087825529016", null));
        startActivity(i);
    }

    @Override
    public void actionEmail() {
        Intent i = new Intent(Intent.ACTION_SENDTO, Uri.parse("mailto:syahrilasidiq0505@gmail.com"));
        startActivity(i);
    }

    @Override
    public void actionInstagram() {
        Intent i = new Intent(Intent.ACTION_VIEW, Uri.parse("https://instagram.com/syahrilasidiq"));
        startActivity(i);
    }

    @Override
    public void actionTwitter() {
        Intent i = new Intent(Intent.ACTION_VIEW, Uri.parse("https://twitter.com/syahrilasidiq"));
        startActivity(i);
    }
